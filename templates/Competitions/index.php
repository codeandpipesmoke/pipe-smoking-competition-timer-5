...
<?php } ?>
											...
											<th class="integer competition-fee"><?= $this->Paginator->sort('competition_fee') ?></th><!-- H.3. -->
...
<?php } ?>
											...
											<td class="integer competition-fee" value="<?= $competition->competition_fee ?>"><?= $this->Number->format($competition->competition_fee, ['places' => 0, 'precision' => 0, 'before' => '', 'after' => '']) ?></td>
