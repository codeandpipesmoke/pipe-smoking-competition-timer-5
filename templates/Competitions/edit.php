...
$this->assign('title', __('Edit') . ' ' . __('Competition'));
?>
						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Competition') ?></h3>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 3. INTEGER: competition_fee: integer  required -->
											<div class="mb-3 form-group row number required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="competition-fee"><?= __('Competition Fee') ?>:</label>
												<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
													<?= $this->Form->control('competition_fee', ['class' => 'form-control', 'placeholder' => __('Competition Fee'), 'data-decimals' => '0', 'min' => '0', 'max' => '999999999999', 'step' => '1', 'empty' => false]); ?>

												</div>
											</div>

											<!-- 7. BOOLEAN: lunch_is_included_in_the_competition_fee: boolean  required -->
											<div class="mb-3 form-group row checkbox">
												<div class="col-sm-2 col-form-label required"></div>
												<div class="col-sm-10">
													<?= $this->Form->control('lunch_is_included_in_the_competition_fee', ['empty' => false]); ?>
											...
											<!-- 6. TIME: start_of_pipe_filling: time  required -->
											<div class="mb-3 row required">
												<label class="pt-2 col-form-label col-md-2 pt-1 text-start text-md-end required" for="start-of-pipe-filling"><?= __('Start Of Pipe Filling') ?>:</label>
												<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
													<div class="form-group time">
														<div class="input-group start-of-pipe-filling" id="start-of-pipe-filling" data-target-input="nearest">
															<?= $this->Form->control('start_of_pipe_filling', ['type' => 'text', 'placeholder' => __('Start Of Pipe Filling'), 'class' => 'form-control', 'empty' => false, 'value' => '']); ?>
											...
											<!-- 6. TIME: start_of_pipe_lighting: time  required -->
											<div class="mb-3 row required">
												<label class="pt-2 col-form-label col-md-2 pt-1 text-start text-md-end required" for="start-of-pipe-lighting"><?= __('Start Of Pipe Lighting') ?>:</label>
												<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
													<div class="form-group time">
														<div class="input-group start-of-pipe-lighting" id="start-of-pipe-lighting" data-target-input="nearest">
															<?= $this->Form->control('start_of_pipe_lighting', ['type' => 'text', 'placeholder' => __('Start Of Pipe Lighting'), 'class' => 'form-control', 'empty' => false, 'value' => '']); ?>
											...
											<!-- 7. BOOLEAN: the_pipe_filling_must_be_repeated: boolean  required -->
											<div class="mb-3 form-group row checkbox">
												<div class="col-sm-2 col-form-label required"></div>
												<div class="col-sm-10">
													<?= $this->Form->control('the_pipe_filling_must_be_repeated', ['empty' => false]); ?>

												</div>
											</div>

											<!-- 7. BOOLEAN: closed_competition: boolean  required -->
											<div class="mb-3 form-group row checkbox">
												<div class="col-sm-2 col-form-label required"></div>
												<div class="col-sm-10">
													<?= $this->Form->control('closed_competition', ['empty' => false]); ?>

												</div>
											</div>

											<!-- 6. TIME: closing_time: time  required -->
											<div class="mb-3 row required">
												<label class="pt-2 col-form-label col-md-2 pt-1 text-start text-md-end required" for="closing-time"><?= __('Closing Time') ?>:</label>
												<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
													<div class="form-group time">
														<div class="input-group closing-time" id="closing-time" data-target-input="nearest">
															<?= $this->Form->control('closing_time', ['type' => 'text', 'placeholder' => __('Closing Time'), 'class' => 'form-control', 'empty' => false, 'value' => '']); ?>
