 ...
 * @var string[]|\Cake\Collection\CollectionInterface $templates
 */
?>
<?php
...
$this->assign('title', __('Edit') . ' ' . __('Diploma'));
?>
				<div id="form-row" class="diplomas row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Diploma') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>

								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Diplomas", "action" => "index", "_full" => true],
...
*/ ?>
							...
							<?= $this->Form->create($diploma, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 2. STRING: competiting_id: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="competiting-id"><?= __('Competiting Id') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('competiting_id', ['label' => __('Competiting Id'), 'placeholder' => __('Competiting Id'), 'class' => 'form-control', 'empty' => false]); ?>
											...
											<!-- 1. SELECT: template_id: integer  required -->
											<div class="mb-3 form-group row select required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="template-id"><?= __('Template Id') ?>:</label>
												<div class="col-md-4">
													<?= $this->Form->control('template_id', ['options' => $templates, 'placeholder' => __('Template Id'), 'class' => 'form-control select2', 'data-live-search' => false, 'data-container' => 'body', 'data-size' => '6', 'empty' => false]);	?>

												</div>
											</div>

											<!-- 3. INTEGER: competitingclub_id: integer  required -->
											<div class="mb-3 form-group row number required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="competitingclub-id"><?= __('Competitingclub Id') ?>:</label>
												<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
													<?= $this->Form->control('competitingclub_id', ['class' => 'form-control', 'placeholder' => __('Competitingclub Id'), 'data-decimals' => '0', 'min' => '0', 'max' => '999999999999', 'step' => '1', 'empty' => false]); ?>
