						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Diploma') ?></h3>
...
<?php } ?>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Competiting Id') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($diploma->competiting_id) ?>
											...
											<div class="row"><!-- 1. -->
												...
												<div class="col-sm-10 p-1 link">
													<?= $diploma->hasValue('user') ? $this->Html->link($diploma->user->id, ['controller' => 'Users', 'action' => 'view', $diploma->user->id]) : '' ?><span class="external-link-icon"><i class="fa fa-external-link" aria-hidden="true"></i></span>
												</div>
											</div>
											<div class="row"><!-- 1. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Template') ?>:</label>
												<div class="col-sm-10 p-1 link">
													<?= $diploma->hasValue('template') ? $this->Html->link($diploma->template->name, ['controller' => 'Templates', 'action' => 'view', $diploma->template->id]) : '' ?><span class="external-link-icon"><i class="fa fa-external-link" aria-hidden="true"></i></span>
												</div>
											</div>
											<div class="row"><!-- 3. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Competitingclub Id') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= $this->Number->format($diploma->competitingclub_id) ?><!-- 3.b -->
												</div>
											</div>
