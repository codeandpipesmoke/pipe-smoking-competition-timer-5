...
$this->assign('title', __('Edit') . ' ' . __('Lang'));
?>
				<div id="form-row" class="langs row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Lang') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($lang, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 2. STRING: english_name: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="english-name"><?= __('English Name') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('english_name', ['label' => __('English Name'), 'placeholder' => __('English Name'), 'class' => 'form-control', 'empty' => false]); ?>
