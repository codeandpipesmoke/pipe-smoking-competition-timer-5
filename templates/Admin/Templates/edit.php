...
$this->assign('title', __('Edit') . ' ' . __('Template'));
?>
				<div id="form-row" class="templates row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Template') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($template, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<!-- 10. TEXT: config: text  required -->
										<div class="tab-pane fade" id="tabPanelConfig" role="tabpanel" aria-labelledby="tabConfig" tabindex="0">
											<div class="row mb-3">
												<div class="col-sm-12">
													<?= $this->Form->control('config', ['id' => 'config', 'label' => false, 'class' => 'summernote', 'empty' => false]); ?>

												</div>
											</div>
										</div><!-- /.TabPanel: tabPanelConfig -->
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitSummerNote('config', 400, '<?= __("Here you can write the note") ?>...') // Init SummerNote for config.
