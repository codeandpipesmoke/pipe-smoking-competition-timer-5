								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 2. STRING: iso: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="iso"><?= __('Iso') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('iso', ['label' => __('Iso'), 'placeholder' => __('Iso'), 'class' => 'form-control', 'empty' => false]); ?>
