...
$this->assign('title', __('Add') . ' ' . __('Setup'));
?>
						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-plus fa-spin"></i> <?= __('Add') ?>: <?= __('Setup') ?></h3>
							...
							<?= $this->Form->create($setup, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<!-- 10. TEXT: value: text  required -->
										<div class="tab-pane fade" id="tabPanelValue" role="tabpanel" aria-labelledby="tabValue" tabindex="0">
											<div class="row mb-3">
												<div class="col-sm-12">
													<?= $this->Form->control('value', ['id' => 'value', 'label' => false, 'class' => 'summernote', 'empty' => false]); ?>
