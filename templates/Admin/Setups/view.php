...
<?php } ?>
											<div class="row"><!-- 1. -->
												...
												<div class="col-sm-10 p-1 link">
													<?= $setup->hasValue('user') ? $this->Html->link($setup->user->id, ['controller' => 'Users', 'action' => 'view', $setup->user->id]) : '' ?><span class="external-link-icon"><i class="fa fa-external-link" aria-hidden="true"></i></span>
												</div>
											</div>
											<div class="row"><!-- 2. -->
											...
											<div class="row"><!-- 5. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Editable') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= $setup->editable ? '<i class="fa fa-check-square boolean-yes" aria-hidden="true"></i>' : '<i class="fa fa-square boolean-no" aria-hidden="false"></i>' ?>
...
*/ ?>
										...
										<!-- TAB for: Value text field -->
										<div class="tab-pane fade" id="tabPanelValue" role="tabpanel" aria-labelledby="tabValue" tabindex="0">
											<div class="row">
												<div class="col-sm-12">
													<div class="row">
														<div id="readMoreValue" class="col-sm-12 p-2 text read-more">
															<?= $this->Text->autoParagraph($setup->value) ?>
