...
$this->assign('title', __('Edit') . ' ' . __('Chairman'));
?>
						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Chairman') ?></h3>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('token-expires'<?= $chairman->token_expires !== null ? ", '" . $chairman->token_expires->format('Y-m-d H:i:s') . "'" : "" ?>)
	jeffAdminInitDateTimePicker('activation-date'<?= $chairman->activation_date !== null ? ", '" . $chairman->activation_date->format('Y-m-d H:i:s') . "'" : "" ?>)
	jeffAdminInitDateTimePicker('tos-date'<?= $chairman->tos_date !== null ? ", '" . $chairman->tos_date->format('Y-m-d H:i:s') . "'" : "" ?>)
	jeffAdminInitDateTimePicker('last-login'<?= $chairman->last_login !== null ? ", '" . $chairman->last_login->format('Y-m-d H:i:s') . "'" : "" ?>)
	jeffAdminInitDateTimePicker('lockout-time'<?= $chairman->lockout_time !== null ? ", '" . $chairman->lockout_time->format('Y-m-d H:i:s') . "'" : "" ?>)
