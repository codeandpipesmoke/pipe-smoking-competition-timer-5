...
$this->assign('title', __('Edit') . ' ' . __('Competingclub'));
?>
				<div id="form-row" class="competingclubs row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Competingclub') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($competingclub, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										</div><!-- /.TabPanel: tabPanelExcludedDescription -->
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitSummerNote('excluded-description', 400, '<?= __("Here you can write the note") ?>...') // Init SummerNote for excluded_description.
	jeffAdminInitTimePicker('time-achieved'<?= $competingclub->time_achieved !== null ? ", '" . $competingclub->time_achieved->format('H:i:s') . "'" : "" ?>)
